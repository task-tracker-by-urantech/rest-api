...
import static com.urantech.restapi.entity.user.UserAuthority.Authority.ADMIN;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .oauth2ResourceServer(jwtCustomizer -> jwtCustomizer
                        .jwt(jwtConfigurer -> jwtConfigurer.jwtAuthenticationConverter(this::convert)))
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(AUTH_WHITELIST).permitAll()
                        .requestMatchers("/api/users").hasAnyAuthority(USER.name(), ADMIN.name())
